...
{\fontsize{20pt}{1}\selectfont EXPERIMENTAL REPORT (Prelab 2)}\\[2.5cm]
\end{center}
...
\Chapter{Pre Laboratory 2}{Adder and flip-flop}

\section{Known how to program full adder}

\ctikzset{logic ports=ieee}

\begin{center}
\noindent$s=a \oplus b \oplus c_{in}$\\
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5, clip, trim={2cm 6.5cm 2cm 7cm}]{images/Exc1_RTL.pdf}
\end{figure}

\section{Understand RS-latched circuit}
\subsection{Code}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7, clip, trim={2cm 8cm 2cm 9cm}]{images/Exc2_RTL.pdf}
\end{figure}

\newpage
\section{Understand D-latched circuit}
\subsection{Code}
\subsubsection{Exc3.vhdl}
\begin{minted}{vhdl}
LIBRARY ieee;
USE ieee.std_logic_1164.ALL;
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7, clip, trim={2cm 8cm 2cm 9cm}]{images/Exc3_RTL.pdf}
\end{figure}
